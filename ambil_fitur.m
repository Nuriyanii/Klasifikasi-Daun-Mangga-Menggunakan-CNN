...
input = [area;perimeter;metric;majoraxis;minoraxis;eccentricity;rataR;
    rataG;rataB;stdR;stdG;stdB;skewnR;skewnG;skewnB; entropR;entropG;entropB];

% labeling
target(1:80) = 1; % daun berpenyakit
target(81:160) = 2; % daun sehat
