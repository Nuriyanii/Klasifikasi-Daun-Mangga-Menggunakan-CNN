...
input = [area;perimeter;metric;majoraxis;minoraxis;eccentricity;rataR;rataG;
    rataB;stdR;stdG;stdB;skewnR;skewnG;skewnB; entropR;entropG;entropB];

% labeling
target(1:20) = 1; % daun sakit
target(21:40) = 2; % daun sehat
